...
/usr/libexec/PlistBuddy -c "Set ACPI:SSDT:Generate:PluginType false" config/config_4x30s.plist
...
/usr/libexec/PlistBuddy -c "Set ACPI:SSDT:Generate:PluginType false" config/config_4x40s.plist
...
/usr/libexec/PlistBuddy -c "Set ACPI:SSDT:Generate:PluginType false" config/config_4x0s_G0.plist
...
/usr/libexec/PlistBuddy -c "Set ACPI:SSDT:Generate:PluginType false" config/config_8x0s_G1_Ivy.plist
...
./merge_plist.sh "KernelAndKextPatches:KextsToPatch" config_parts/config_Kabylake.plist config/config_4x0s_G4_Kabylake.plist
...
printf "\n"
printf "!! creating config/config_4x0s_G5_Kabylake-R.plist\n"
cp config/config_4x0s_G4_Kabylake.plist config/config_4x0s_G5_Kabylake-R.plist
printf "\n"
