...
ESSENTIAL="FakeSMC.kext SATA-100-series-unsupported.kext IntelMausiEthernet.kext RealtekRTL8111.kext USBInjectAll.kext FakePCIID.kext FakePCIID_XHCIMux.kext FakePCIID_Intel_HD_Graphics.kext Lilu.kext IntelGraphicsFixup.kext AppleBacklightInjector.kext IntelBacklight.kext VoodooPS2Controller.kext"
