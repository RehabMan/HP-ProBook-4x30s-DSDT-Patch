...
$(BUILDDIR)/SSDT-9x80.aml: $(HOTPATCH)/SSDT-RMCF.asl $(HOTPATCH)/SSDT-HACK.asl $(HOTPATCH)/include/layout4_HDEF.asl $(HOTPATCH)/include/layout4_HDAU.asl $(HOTPATCH)/include/standard_PS2K.asl $(HOTPATCH)/SSDT-KEY87.asl $(HOTPATCH)/SSDT-USB-9x80.asl $(HOTPATCH)/SSDT-EH01.asl $(HOTPATCH)/SSDT-EH02.asl $(HOTPATCH)/SSDT-XHC.asl $(HOTPATCH)/SSDT-BATT.asl

$(BUILDDIR)/SSDT-4x0-G0.aml: $(HOTPATCH)/SSDT-RMCF.asl $(HOTPATCH)/SSDT-HACK.asl $(HOTPATCH)/include/layout17_HDEF.asl $(HOTPATCH)/include/standard_PS2K.asl $(HOTPATCH)/SSDT-KEY87.asl $(HOTPATCH)/SSDT-EH01.asl $(HOTPATCH)/SSDT-EH02.asl $(HOTPATCH)/SSDT-XHC.asl $(HOTPATCH)/SSDT-BATT.asl
