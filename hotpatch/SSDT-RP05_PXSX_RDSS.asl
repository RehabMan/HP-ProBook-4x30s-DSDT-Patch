...
//{
    ...
    Scope(RMCF)
    {
        Method(RMOF) { If (1 == DGPU && CondRefOf(\_SB.PCI0.RP05.PXSX._OFF)) { \_SB.PCI0.RP05.PXSX._OFF() } }
        Method(RMON) { If (1 == DGPU && CondRefOf(\_SB.PCI0.RP05.PXSX._OFF)) { \_SB.PCI0.RP05.PXSX._ON() } }
