...
//{
    ...
    Scope(RMCF)
    {
        Method(RMOF) { If (1 == DGPU && CondRefOf(\_SB.PCI0.PEGP.DGFX._OFF)) { \_SB.PCI0.PEGP.DGFX._OFF() } }
        Method(RMON) { If (1 == DGPU && CondRefOf(\_SB.PCI0.PEGP.DGFX._OFF)) { \_SB.PCI0.PEGP.DGFX._ON() } }
