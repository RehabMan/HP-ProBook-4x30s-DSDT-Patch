...
//{
    ...
    Scope(RMCF)
    {
        Method(RMOF) { If (1 == DGPU && CondRefOf(\_SB.PCI0.RP01.PEGP._OFF)) { \_SB.PCI0.RP01.PEGP._OFF() } }
        Method(RMON) { If (1 == DGPU && CondRefOf(\_SB.PCI0.RP01.PEGP._OFF)) { \_SB.PCI0.RP01.PEGP._ON() } }
